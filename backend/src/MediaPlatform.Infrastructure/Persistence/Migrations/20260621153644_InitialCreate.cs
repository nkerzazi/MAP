        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WatchSeconds = table.Column<double>(type: "double precision", nullable: false),
                    OccurredAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ManifestKey = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { new Guid("22222222-2222-2222-2222-222222222222"), "Editeur" },
                    { new Guid("33333333-3333-3333-3333-333333333333"), "Visiteur" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VideoRenditions_VideoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ViewEvents_VideoId_OccurredAt",
                table: "ViewEvents",
                columns: new[] { "VideoId", "OccurredAt" });
        }
